...
import { Home, Menu, BotMessageSquare, FlaskConical, Github } from "lucide-react";
            ...
            <div className="flex h-full max-h-screen flex-col gap-2">
              <div className="flex h-14 items-center border-b px-4 lg:h-[60px] lg:px-6">
                <Link href="/" className="flex items-center gap-2 font-semibold">
                  <BotMessageSquare className="h-6 w-6 text-cyan-400" />
          ...
          <div className="flex flex-col">
            <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-[60px] lg:px-6">
                ...
                <SheetContent side="left" className="flex flex-col">
                  <nav className="grid gap-2 text-lg font-medium">
                    <Link href="#" className="flex items-center gap-2 text-lg font-semibold mb-4">
                       <BotMessageSquare className="h-6 w-6 text-cyan-400" />
                      <span className="sr-only">Robolog AI</span>
                    </Link>
                    {navItems.map(item => (
              ...
              <Button variant="outline" size="icon" asChild>
                <a href="https://github.com/a-g-m-j/robolog" target="_blank" rel="noopener noreferrer">
